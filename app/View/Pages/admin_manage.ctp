				...
				<?php echo $this->Form->create('Page', array('action' => 'admin_manage/'.$id, 'id'=>"form_sample_3", 'class'=>"form-horizontal", "type"=>"file", 'inputDefaults' => array('required' => false, 'label' => false,'div' => false))); ?>
					<div class="form-body">
						...
						<!--<div class="form-group">
							...
							<div class="col-md-8">
								<?php
									if(!empty($data['Page']['page_banner_image'])){
										echo '<div class="col-md-3">';
										echo $this->Html->image(IMGPATH.'page_banner_image/thumb/'.$data['Page']['page_banner_image'], array('alt'=>'Image'));
										echo '</div>';
										echo '<div class="col-md-4">';
										echo $this->Html->link('<i class="fa fa-trash-o"></i> Delete', array(
											'controller'=>'Posts',
											'action'=>'admin_imgdelete',
											'image_name'=>$data['Page']['page_banner_image'],
											'id'=>$id
										), 
										array('confirm' => 'Are you Sure?', 'escape'=>false, 'full_base'=>true, 'class'=>'btn default btn-xs red')
										);
										echo '</div>';
										echo $this->Form->input('set_banner_image', array('type'=>'hidden','value'=>$data['Page']['page_banner_image'],'class'=>'set'));
									} else {
										echo $this->Form->input('page_banner_image', array(
															'type' => "file"
														));  
										echo " &nbsp "."<font color='red'>(Recommended Size 1600 x 597)</font>"; 
										echo $this->Form->input('set_banner_image', array('type'=>'hidden','value'=>'','class'=>'set'));
									}
								?>
							</div>
						</div>-->
