	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				<!-- BEGIN FORM-->
				<?php echo $this->Form->create('Page', array('action' => 'admin_clientmanage/'.$id, 'id'=>"form_sample_3", 'class'=>"form-horizontal", "type"=>"file", 'inputDefaults' => array('required' => false, 'label' => false,'div' => false))); ?>
					<div class="form-body">
						<?php echo $this->Form->input('id',array("id"=>"id","type"=>"hidden","label"=>false,"value"=> $id)); ?>
						<?php echo $this->Form->input('def',array("id"=>"def","type"=>"hidden","label"=>false,"value"=>'def')); ?>
						<?php
								...
								<div class="note note-warning" id="tplPreview">
									...
									?>
										<div class="note <?php echo ($colCount > 12)?'note-danger':'note-success'; ?>" id="row-<?php echo $item['PageTemplateRow']['id']; ?>">
											...
											foreach($item['PageTemplateRowsColumn'] as $column){ ?>
													...
													<div class="panel panel-info">
														<div class="panel-heading">
															<center>
																...
																<span class="colmane"><?php echo $columname[$b]['EditPageTemplateRowsColumn']['name']; ?></span>
														...
														<div class="panel-body">
															...
															<!--<center>
																...
																if($column['clone_flag']=='N'){
																	echo $cloneLink = $this->Template->cloneLink('['.$pageArrrdetail2[$b].']', $item['PageTemplateRow']['template_id'], $column['id']);
																}
																//pr($widg);
																?>
																</div>
						...
						<?php
						//echo $b;
						$shortcode='['.$pageArrrdetail2[$b].']';
						echo $this->Template->shortcode($shortcode,$column['clone_flag'], $item['PageTemplateRow']['template_id'], $column['id'],'bal');
						$b=$b+1 ;
						?>
						<?php } else {
											...
											<div class="panel-heading">
												...
												echo $this->Html->link('<i class="fa fa-edit"></i>', 'javascript:void(0);',
													array(
														...
														'class'=>'editCustomCol1',
														'data-rowid'=>$item['PageTemplateRow']['id'],
							'data-colid'=>$childCol['PageTemplateRowsColumn']['parent_colid'],
							'data-parentcolid'=>$childCol['PageTemplateRowsColumn']['id'],
							'data-pageid'=>$data['Page']['id'],
														'data-templateid'=>$item['PageTemplateRow']['template_id'],
														'data-templateFor'=>"I",
														'data-url'=>$this->Html->url(array('controller'=>'Pages', 'action'=>'admin_fpaddcol', 'full_base'=>true)),
											...
											<div class="panel-body">
												<?php
												$shortcode='['.$pageArrrdetail2[$b].']';
												echo $this->Template->shortcode($shortcode, $childCol['PageTemplateRowsColumn']['clone_flag'], $item['PageTemplateRow']['template_id'], $childCol['PageTemplateRowsColumn']['id'],$childCol['PageTemplateRowsColumn']['parent_colid']);
												?>
											<!--<center>
												<div class="col-md-8">
												<?php 
