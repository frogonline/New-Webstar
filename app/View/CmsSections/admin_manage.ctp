	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				<!-- BEGIN FORM-->
				<?php echo $this->Form->create('CmsSection', array('action' => 'admin_manage/'.$id, 'id'=>"form_sample_3", 'class'=>"form-horizontal", "type"=>"post", 'inputDefaults' => array('required' => false, 'label' => false,'div' => false))); ?>
					<div class="form-body">
	...
	?>
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-4">
								<?php echo $this->Form->input('title',array('value'=>(isset($data['CmsSection']))?$data['CmsSection']['title']:'', 'class'=>"form-control", 'placeholder'=>"Enter Title", 'type'=>"text")); ?>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<?php echo $this->Form->input('heading',array('value'=>(isset($data['CmsSection']))?$data['CmsSection']['heading']:'','class'=>"form-control", 'placeholder'=>"Enter Heading", 'type'=>"text")); ?>
							</div>
						</div>
							...
							* </span>
							...
							<div class="col-md-8">
								<?php	echo $this->Form->input('descriptions', array(
															...
															'value' => (isset($data['CmsSection']))?$data['CmsSection']['descriptions']:'', 
								...
								<div class="input-group">
									<?php  
										echo $this->Form->input('status', array(
																...
																'empty' => 'Select Status',	
																'class' => 'form-control',
																'selected'=> (isset($data['CmsSection']))?$data['CmsSection']['status']:''
															));
									?>  
								</div>
							</div>
...
$(function(){
	...
	form3.validate({
		...
		rules: {
			'data[CmsSection][title]': {
				required: true
			}, 
			'data[CmsSection][descriptions]': {
				required: true
			},
			'data[CmsSection][descriptions]': {
				required: true
