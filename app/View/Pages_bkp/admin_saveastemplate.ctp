<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h2 class="modal-title">Save New Template As</h2>
		</div>
		...
		<div class="modal-body">
			<div class="scroller" data-always-visible="1" data-rail-visible1="1">
				<div class="row">
					<div class="col-md-12">
						<div class="col-md-12">
							<h4>Template Name <span class="required"> * </span></h4>
							<?php echo $this->Form->input('template_name', array('type'=>'text', 'data-required'=>1,'placeholder'=>"Enter Template Name", 'class'=>'col-md-12 form-control'));
							?>
						</div>
					</div>
				</div>
		...
		<div class="modal-footer">
			<?php
				...
				echo $this->Form->button('Proceed', array('type' => 'submit', 'class'=>"btn green"));
			?>
