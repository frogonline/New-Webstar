	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-gift"></i><?php echo (isset($id))?'Edit':'Add' ?> Accordion
				</div>
			</div>
			<div class="portlet-body form">
				<!-- BEGIN FORM-->
				<?php echo $this->Form->create('Accordion', array('action' => 'admin_manage/'.$id, 'id'=>"form_sample_3", 'class'=>"form-horizontal", "type"=>"file", 'inputDefaults' => array('required' => false, 'label' => false,'div' => false))); ?>
					<div class="form-body">
					<?php echo $this->Form->input('id',array("type"=>"hidden","label"=>false,"id"=>"box_id","value"=> $id)); ?>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<?php echo $this->Form->input('name',array('value'=>(isset($data['Accordion']))?$data['Accordion']['name']:'',  'data-required'=>1, 'class'=>"form-control", 'placeholder'=>"Enter Accordion Name", 'type'=>"text")); ?>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								...
								echo $this->Form->input('headingfrontend_flag', array(
										...
										'value'=>(!empty($data))?$data['Accordion']['headingfrontend_flag']:'',
										'type'=>'radio',
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-4">
									<?php 
										/* $styles = array(''=>'Select Style','style1'=>'One Toggle Open','style2'=>'Multiple Toggle Open','style3'=>'Category based Accordions');
										echo $this->Form->input('style',
																array('options'=>$stylesArr, 
																	  ...
																	  'class'=>"form-control",
																	  'id' =>'styler',
																	  'disabled'=>(isset($data['Accordion']))?'true':'false',
																	  'selected'=> (isset($data['Accordion']))?$data['Accordion']['style']:'')
																); */
									  ?>
								<?php echo $this->Form->input('style',array('value'=>(isset($data['Accordion']))?$data['Accordion']['style']:'',  'data-required'=>1, 'class'=>"form-control",'id'=>"styid" ,'placeholder'=>"Enter Accordion style", 'type'=>"text", 'readonly'=>(!empty($id))?true:false)); ?>		  
							</div>
							<div class="col-md-4">
							<?php 
							if(!empty($id)){
						...
						<div id="category" >
							<?php
								...
								{
									$category = explode(",",$data['Accordion']['category']);
							...
							?>
								<div class="form-group">
									...
									<div class="col-md-4">
										<?php echo $this->Form->input('category',array('value'=>(isset($data['Accordion']))?$cat:'',  'data-required'=>1, 'class'=>"form-control", 'placeholder'=>"Enter Category Name", 'type'=>"text",'name'=>"data[Accordion][category][]")); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<?php echo $this->Form->input('category',array('value'=>(isset($data['Accordion']))?$data['Accordion']['name']:'',  'data-required'=>1, 'disabled'=>(isset($data['Accordion']))?'true':'false', 'class'=>"form-control", 'placeholder'=>"Enter Category Name", 'type'=>"text",'name'=>"data[Accordion][category][]")); ?>
								...
								<div class="input-group">
									<?php  
										echo $this->Form->input('status', array(
																...
																'empty' => 'Select Status',	
																'class' => 'form-control',
																'selected'=> (isset($data['Accordion']))?$data['Accordion']['status']:''
															));
									?>  
								</div>
							</div>
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<a data-toggle="modal" href="#responsive" class="btn red add" style="float:right"><i class="fa fa-plus"></i> Add Accordion Content</a>	
			</div>
					...
					<tbody>
						...
						<tr>
							...
							<td  align="center" width="11%" >
								...
								<div class="col-md-6">
								<?php
									echo $this->Html->link('<i class="fa fa-trash-o"></i> Delete', array('controller'=>'Accordions', 'action'=>'admin_boxdelete/'.$databoxcontent['id'].'/1'), array('escape'=>false, 'confirm' => 'Do you really want to delete this Accordion?', 'full_base'=>true, 'class'=>'btn default btn-xs red'));
								?>
								</div>
							</td>
						</tr>
...
$(function(){
	...
	form3.validate({
		...
		rules: {
			...
			'data[Accordion][headingfrontend_flag]': {
				required: true
			},
			'data[Accordion][style]': {
				required: true
			},  
