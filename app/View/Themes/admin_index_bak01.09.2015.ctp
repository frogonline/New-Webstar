			...
			<div class="portlet-body form">
				...
				<?php echo $this->Form->create('ThemeSetting', array('url'=>array('controller'=>'Themes','action' => 'admin_index'), 'id'=>"form_sample_3", 'class'=>"form-horizontal", "type"=>"file", 'inputDefaults' => array('required' => false, 'label' => false,'div' => false))); ?>
					<div class="form-body">
						<?php 
							if(!empty($data)){
								echo $this->Form->input('theme_id',array("type"=>"hidden","label"=>false,"value"=> $data['ThemeSetting']['theme_id']));
							}								
						?>
						...
						<div class="form-group">
							<label class="control-label col-md-3">Footer Heading <span class="required">* </span>
							</label>
								<div class="col-md-4">
									<div class="input-group color colorpicker-default" data-color="<?php echo (!empty($data))?$data['ThemeSetting']['footer_heading']:'#219fd1'; ?>" data-color-format="rgba">
										<?php echo $this->Form->input('footer_heading',array('class'=>"form-control",'placeholder'=>"Enter Footer Heading Color", 'type'=>"text", 'value'=>(!empty($data))?$data['ThemeSetting']['footer_heading']:'')); ?>
										<span class="input-group-btn">
											<button class="btn default" type="button">
												<i style="background-color: <?php echo (!empty($data))?(!empty($data['ThemeSetting']['footer_heading']))?$data['ThemeSetting']['footer_heading']:'#219fd1':'#219fd1'; ?>;"></i>&nbsp;
											</button>
										</span>
									</div>
									<?php echo $this->Form->input('previous_footer_heading', array('type'=>'hidden','value'=>(!empty($data))?$data['ThemeSetting']['footer_heading']:'#219fd1' )); ?>
									<!-- /input-group -->
								</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3">Footer Text Color <span class="required">* </span>
							</label>
								<div class="col-md-4">
									<div class="input-group color colorpicker-default" data-color="<?php echo (!empty($data))?$data['ThemeSetting']['footer_text_color']:'#219fd1'; ?>" data-color-format="rgba">
										<?php echo $this->Form->input('footer_text_color',array('class'=>"form-control",'placeholder'=>"Enter Footer Text Color", 'type'=>"text", 'value'=>(!empty($data))?$data['ThemeSetting']['footer_text_color']:'')); ?>
										<span class="input-group-btn">
											<button class="btn default" type="button">
												<i style="background-color: <?php echo (!empty($data))?(!empty($data['ThemeSetting']['footer_text_color']))?$data['ThemeSetting']['footer_text_color']:'#219fd1':'#219fd1'; ?>;"></i>&nbsp;
											</button>
										</span>
									</div>
									<?php echo $this->Form->input('previous_footer_text_color', array('type'=>'hidden','value'=>(!empty($data))?$data['ThemeSetting']['footer_text_color']:'#219fd1' )); ?>
									<!-- /input-group -->
								</div>
						</div>
						<div class="form-group">
