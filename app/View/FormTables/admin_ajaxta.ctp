...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h2><?php echo (!empty($id))?'Edit':'Add'; ?> Text Area Tool</h2>
		</div>
		<!-- BEGIN FORM-->
				...
				<div class="row">
					<div class="col-md-6">
						...
						echo $this->Form->input('rows', array(
								'type'=>'text',
								'class'=>"form-control",
								'value'=>(!empty($data))?$data['FormTool']['rows']:'',
								'data-required'=>1
							)
						);
						?>
					...
					<div class="col-md-6">
						...
						echo $this->Form->input('cols', array(
								'type'=>'text',
								'class'=>"form-control",
								'value'=>(!empty($data))?$data['FormTool']['cols']:'',
								'data-required'=>1
							)
						);
						?>
		...
		<div class="modal-footer">
			<?php 
				echo $this->Form->input('tool_type', array('type' => 'hidden', 'value'=>"TA"));
