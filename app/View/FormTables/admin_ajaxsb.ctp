...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h2><?php echo (!empty($id))?'Edit':'Add'; ?> Select Box Tool</h2>
		</div>
		<!-- BEGIN FORM-->
			...
			<div class="scroller" data-always-visible="1" data-rail-visible1="1">
				...
				<div class="row">
					<div class="col-md-6">
						<h4>Is Multiple ?</h4>
						<?php 
							echo $this->Form->input('multiple_flag',
													array('options'=>$ismultipleArr, 
														  'default'=>'',	
														  'data-required'=>1, 
														  'class'=>"form-control",
														  'selected'=>(!empty($data))?$data['FormTool']['multiple_flag']:''
													));
						?>
					</div>
				...
				<div class="row" style="padding:15px 0 0 0;">
					...
					<?php 
					if(!empty($data)){
						echo $this->Form->button('Add Option', array('type' => 'button', 'id'=>'addrowBtn', 'data-id'=>$datamax['FormToolOption']['id'], 'class'=>"btn green")); 
					} else {
		...
		<div class="modal-footer">
			<?php 
				echo $this->Form->input('tool_type', array('type' => 'hidden', 'value'=>"SB"));
