	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				<!-- BEGIN FORM-->
				<?php echo $this->Form->create('ContactWidget', array('action' => 'admin_manage/', 'id'=>"form_sample_3", 'class'=>"form-horizontal", "type"=>"file", 'inputDefaults' => array('required' => false, 'label' => false,'div' => false))); ?>
					<div class="form-body">
					  <?php echo $this->Form->input('id',array('value'=>(isset($data['ContactWidget']))?$data['ContactWidget']['id']:'', 'type' => 'hidden'));?>
					  
					  <div class="form-group">
							<label class="control-label col-md-3">Contact Widget Name <span class="required">
							</span>
							</label>
							<div class="col-md-4">
								<?php echo $this->Form->input('name',array('value'=>(isset($data['ContactWidget']))?$data['ContactWidget']['name']:'', 'data-required'=>1, 'class'=>"form-control", 'placeholder'=>"Contact Widget Name", 'type'=>"text")); ?>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								...
								echo $this->Form->input('headingfrontend_flag', array(
										...
										'value'=>(!empty($data))?$data['ContactWidget']['headingfrontend_flag']:'',
										'type'=>'radio',
						...
						<div class="form-group">
							<label class="control-label col-md-3">Contact Widget Text <span class="required">
							* </span>
							</label>
							<div class="col-md-4">
								<?php echo $this->Form->input('text',array('value'=>(isset($data['ContactWidget']))?$data['ContactWidget']['text']:'', 'data-required'=>1, 'class'=>"form-control", 'placeholder'=>"Contact Widget Text", 'type'=>"text")); ?>
							</div>
						</div>
							...
							* </span>
							...
							<div class="col-md-4">
								<?php /* echo $this->Form->input('style', array(
																...
																'empty' => 'Select Style',	
																'class' => 'form-control',
																'selected'=> (isset($data['ContactWidget']))?$data['ContactWidget']['style']:''
															)); */ ?>
							
								<?php echo $this->Form->input('style',array('value'=>(isset($data['ContactWidget']))?$data['ContactWidget']['style']:'',  'data-required'=>1, 'class'=>"form-control",'id'=>"styid" ,'placeholder'=>"Enter Box style", 'type'=>"text")); ?>							
								...
								<div class="input-group">
									<?php  
										echo $this->Form->input('status', array(
																...
																'empty' => 'Select Status',	
																'class' => 'form-control',
																'selected'=> (isset($data['ContactWidget']))?$data['ContactWidget']['status']:''
															));
									?>  
								</div>
							</div>
...
<div id="stack1" class="modal fade" tabindex="-1" data-width="400" >
	<div class="modal-dialog" style="height:5000px; width:1200px; z-index: 1050;">
		...
		<?php 
		if(!empty($contactstyledata)){
			echo '<div class="modal-body">';
			echo '<div class="row">';
			foreach($contactstyledata as $item){
...
$(function(){
	...
	form3.validate({
		...
		rules: {
			...
			'data[ContactWidget][headingfrontend_flag]': {
				required: true
			},
			'data[ContactWidget][text]': {
				required: true
			},
			'data[ContactWidget][style]': {
				required: true
			},
			'data[ContactWidget][is_active]': {
				required: true
			}
		},
