					...
					<div class="form-body">
						...
						<!--<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
										<div id="s2id_select2_tags" class="select2-container select2-container-multi form-control">
										 <?php //echo $this->Form->input('categoryid', array('class' => 'form-control js-example-basic-multiple','multiple' => 'multiple', 'options' => $ptag, 'label' => false)); ?>
										</div>
										<div id="editor2_error"></div>
										</div>
						</div>-->
						<div class="form-group">
							...
							<div class="col-md-4">
								...
								<?php 
									echo $this->Form->input('tagid', array('class' => 'form-control', 'id'=>"postassignTags",'label' => false, 'value'=>$tagAssignIDString)); 
									echo $this->Form->input('set_tagid', array('type'=>'hidden', 'value'=>$tagAssignIDString)); 
								?>
							</div>
						</div>
...
$(function(){
	...
	$("#postassignTags").select2({
		tags:<?php echo $tagString; ?>
	});
	//$("#select2_tags").select2('val',[<?php //echo $tagAssignNameString; ?>] );
});
</script>