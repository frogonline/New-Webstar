			...
			<div class="portlet-body form">
				...
				<?php echo $this->Form->create('Page', array('action' => 'admin_manage/'.$id, 'id'=>"form_sample_3", 'class'=>"form-horizontal", "type"=>"file", 'inputDefaults' => array('required' => false, 'label' => false,'div' => false))); ?>
					<div class="form-body">
						...
						<?php if($data['Page']['type']=='Page'){ ?>
						<div class="form-group">
							<label class="control-label col-md-3">Summery 
							</label>
							<div class="col-md-6">
								<?php 
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<div class="input-group">
									<?php  
										echo $this->Form->input('cms_banner_id', array(
																'options' => $cmsbanner,
																'empty' => 'Select Status',	
																'class' => 'form-control',
																'selected'=> (isset($data['Page']))?$data['Page']['cms_banner_id']:''
															));
									?>  
								</div>
							</div>
