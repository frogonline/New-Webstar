	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-gift"></i><?php echo (isset($id))?'Edit':'Add' ?> FAQ Category
				</div>
			</div>
			<div class="portlet-body form">
				<!-- BEGIN FORM-->
				<?php echo $this->Form->create('FaqCategory', array('action' => 'admin_manage/'.$id, 'id'=>"form_sample_3", 'class'=>"form-horizontal", "type"=>"post", 'inputDefaults' => array('required' => false, 'label' => false,'div' => false))); ?>
					<div class="form-body">
							...
							* </span>
							...
							<div class="col-md-4">
								<?php	echo $this->Form->input('category', array(
															...
															'value' => (isset($data['FaqCategory']))?$data['FaqCategory']['category']:'', 
															'class' => "form-control"
														)); 
								?>
							</div>
								...
								<div class="input-group">
									<?php  
										echo $this->Form->input('status', array(
																...
																'empty' => 'Select Status',	
																'class' => 'form-control',
																'selected'=> (isset($data['FaqCategory']))?$data['FaqCategory']['status']:''
															));
									?>  
								</div>
							</div>
					...
					<div class="form-actions fluid">
						<div class="col-md-offset-3 col-md-9">
							...
							<?php echo $this->Form->button('Save & Close', array('type' => 'submit', 'class'=>"btn blue",'div'=>false));?>
