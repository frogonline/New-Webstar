...
(function ($) { "use strict";
    ...
    $.fn.Holo_Gallery = function () {
        ...
        $gallery_container.prepend('<div class="main frame box-background"><div class="preview-wrapper mgp-gal"></div></div>');

        var $main_frame = $('.main.frame');

        var $preview_wrapper = $('.preview-wrapper', $gallery_container);

        var navigation = '<a class="control left box-background"><i class="fa fa-chevron-right"></i></a><a class="control right box-background"><i class="fa fa-chevron-left"></i></a>';
