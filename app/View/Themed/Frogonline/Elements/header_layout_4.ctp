<header class="head-2">
	...
	<div class="logo hidden-sm hidden-xs">
		<div class="container">
			<!--<a class="logo-box center-block" href="../homepages/home-corp1.php">
	...
	<div class="container menu-bar headerbutton_backgound" role="navigation">
		...
		<div class="large-header">
			...
			?>
			<?php
				$menu_class = (!empty($theme))?'nav navbar-nav text-center '.$theme['ThemeSetting']['header_menu_style']:'nav navbar-nav';
				$default = array(
