	...
	<div class="container menu-bar headerbutton_backgound" role="navigation">
		...
		<div class="large-header">
			...
			if($theme['ThemeSetting']['header_type']=='H'){
				$menu_class = (!empty($theme))?'nav navbar-nav navbar-right ':'nav navbar-nav';
				$default = array(
		...
		<div class="mobile-header">
			...
			?>
				<a data-toggle="collapse" href="#search" class="collapsed"> <i class="fa  fa-search magnify_glass"></i> </a>
			</div>
			<?php
