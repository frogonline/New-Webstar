...
<div class="panel-body row">
	...
	<div class="col-md-12 col-sm-6">
		...
		<?php if($siteSettings['SiteSetting']['shipping_flag']=='C'){?>
							<div class="col-md-12">
							<p style="padding-left:10px">Select Shipping Methods.</p>
							<div class="radio-list">
								<?php 
								...
								<br/>
								<br/>
								<p id="fff" style="padding-left:19px"></p>
							</div>
							<br/>
							<div id="scha" style="display:none;padding-left:14px" class="form-group"></div>
		...
		<?php }else if($siteSettings['SiteSetting']['shipping_flag']=='I') { ?>
			...
			$valueshipping=$this->Layout->generateShippingArray($productinformationre['Product']['id'],$stateitem);
				...
				?>
				<div id="schaww" style="padding-left:14px" class="form-group control-label">Shipping charges : <?php echo CURRENCY."".$valueshipping1;  ?></div>
		...
		<div class="form-group" style="padding-left:14px">
			...
			<label class="control-label col-md-12"><?php echo $this->Form->input('order_comments', array('type'=>'textarea', 'class'=>'form-control', 'row'=>'8')); ?></label>
		...
		<?php 
			...
			<?php echo $this->Form->button('Continue', array('class'=>'btn btn-primary pull-right', 'type'=>'submit', 'data-toggle'=>'collapse', 'data-parent'=>'#checkout-page', 'data-target'=>'#payment-method-content')); 
			?>
			</label>
