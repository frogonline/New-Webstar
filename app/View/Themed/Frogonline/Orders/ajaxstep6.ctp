<div class="panel-body row">
	<div class="col-md-12 clearfix">
			...
			<table class="table" width="100%" border="0">
				...
				<tr>
					...
					<td class="checkout-price">
						<strong><span><?php echo CURRENCY.''.number_format($item['Cart']['unit_price'], 2); ?></strong>
						
						
					</td>
					<td class="checkout-total">
						<strong><span><?php echo CURRENCY.''.number_format($item['Cart']['gross_price'], 2); ?></strong>
        ...
        <div class="row">
		<div class="col-md-6 col-md-offset-6 main-el shop-panel">
			<div class="totals alt-bg-color">
				...
				<div class="inside">
					<div class="line cart-sub clearfix">
						...
						<div class="value"><span><?php echo CURRENCY.''.number_format($cartArr = $this->Layout->totalCartPrice(),2); ?></div>
		...
		<?php 
			...
			echo $this->Form->button('Confirm Order', array('class'=>'btn btn-primary pull-right brown-bg mrgtop5', 'type'=>'submit')); 
		?>
