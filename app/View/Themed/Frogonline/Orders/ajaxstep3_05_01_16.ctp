...
<div class="panel-body row">
	...
	<div class="col-md-6 col-sm-6">
		...
		<div class="form-group" id="shiping_city_div">
	...
	<div class="col-md-12">
		<?php 
			...
			echo $this->Form->button('Continue', array('class'=>'btn btn-primary pull-right', 'type'=>'submit', 'data-toggle'=>'collapse', 'data-parent'=>'#checkout-page', 'data-target'=>'#shipping-method-content')); 
		?>
	</div>
