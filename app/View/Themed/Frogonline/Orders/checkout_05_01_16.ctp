					...
					<?php if(!$this->Session->read('loggedin_status')) { ?>
						<div class="panel-body row">
							...
							<div class="col-md-6 col-sm-6">
								...
								<?php echo $this->Form->button('Continue', array('class'=>'btn btn-primary', 'id'=>'checkout_option_button', 'type'=>'submit', 'data-toggle'=>'collapse', 'data-parent'=>'#checkout-page', 'data-target'=>'#payment-address-content')); ?>
							</div>
