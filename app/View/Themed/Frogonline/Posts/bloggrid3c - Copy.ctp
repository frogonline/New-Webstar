			...
			<div class="col-sm-4 element-wrap isotope-element isotope-item">
				<div class="element">
					...
					<?php if($postarr['Page']['cms_image']!=''){ ?>
						<div class="image">
							<div class="overlay blog_image_backgound">
							<?php
					...
					<div class="body shop-box-background shop-box-text blog_box_backgound">
						<h5 class="medium">
						<?php echo $this->Html->link($postarr['Page']['title'], SITE_URL.$postarr['Page']['slug'],array('class'=>'blog_name_control')); ?>
						</h5>
...
$('#post-loadmore').click(function(){
	...
	$('#loadmoreicon').show();
	  ...
	  $.ajax({
			type:'POST',
			url:'<?php echo $this->Html->url(array('controller'=>'Posts','action'=>'ajaxpostlist','full_base'=>true)); ?>',
			data:{pageno:pageno},
