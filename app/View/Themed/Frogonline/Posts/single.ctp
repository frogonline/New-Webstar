		...
		<div class="row">
			<div class="main-el clearfix">
				...
				<div class="<?php echo $mainClass; ?>">
					...
					<?php echo $postDetails['Page']['content']?>  
					...
					<div class="form-3" id="comment_form">
						...
						<div class="form-3 main-el">
							...
							<div class="row">
								...
								<div class="col-sm-6 mob-mrgbtm25">
									<div id="RecaptchaField1"></div>
									<span class="captcha-required"></span>
								</div>
								<div class="col-md-12">
								<a class="button solid sm blue blog_button_control blog_button_backgound"><div class="over"><i class="fa fa-plane"></i><?php echo $this->Form->button('Post a Comment', array('type'=>'submit', 'class'=>'button solid blue sm blog_button_control blog_button_backgound'));?></div></a>
								</div>
