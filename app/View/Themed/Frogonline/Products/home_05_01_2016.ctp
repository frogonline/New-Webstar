						...
						<div class="<?php echo ($ThemeSettingheadertype=='V')?'col-md-4':'col-md-3'; ?> col-sm-6 main-el isotope-element isotope-element">
							<div class="shop-col-item">
								...
								<div class="info shop-box-background shop-box-text">
									<div>
										<div class="price">
											<h5><?php echo $this->Html->link($newArv['Product']['product_name'], SITE_URL.$newArv['Product']['product_slug']) ?></h5>
											<h5 class="main-text-color"><?php echo CURRENCY.number_format($this->Layout->actualprice($newArv['Product']['id']),2); ?></h5>
										</div>
										<div class="rating">
											<i class="main-text-color fa fa-star"></i>
											<i class="main-text-color fa fa-star"></i>
									...
									<div class="btns clear-left">
										<?php if(!empty($options)) {?>
											<p class="btn-add"><i class="fa fa-shopping-cart"></i><?php echo $this->Html->link('Add to cart',SITE_URL.$newArv['Product']['product_slug']); ?></p>
										<?php } else { ?>
											<p class="btn-add">
											<?php 
												echo $this->Html->link('<i class="fa fa-shopping-cart"></i> Add to cart','javascript:void(0);', array('onclick'=>'submitcart('.$newArv['Product']['id'].');', 'escape'=>false)); 
											?>
											</p>
											<?php
										...
										<?php } ?>
										<p class="btn-details"><i class="fa fa-list"></i>
										<?php echo $this->Html->link('More details', SITE_URL.$newArv['Product']['product_slug']) ?>									
										</p>
									</div>
									<div class="clearfix"></div>
								</div>
