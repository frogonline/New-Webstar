...
?>
	...
	<div class="col-sm-4 col-sm-6 main-el">
		<div class="shop-col-item">
			...
			<div class="info shop-box-background shop-box-text ecombox1_backgound">
				<div>
					<div class="price">
						<h5><?php echo $this->Html->link($product['Product']['product_name'], SITE_URL.$product['Product']['product_slug'].'/'.$catalog_id,array('class'=>"ecombox_pname")) ?></h5>
						<h5 class="main-text-color ecombox_pprice"><?php echo CURRENCY.number_format($this->Layout->mainprice($product['Product']['id'],$catalog_id),2); ?></h5>
					</div>
				...
				<div class="btns clear-left">
					<?php if(!empty($options)){ ?>
						<p class="btn-add"><i class="fa fa-shopping-cart"></i><?php echo $this->Html->link('Add to cart',SITE_URL.$product['Product']['product_slug'].'/'.$catalog_id,array('class'=>"ecombox_addtocart")); ?></p>
					<?php } else { ?>
