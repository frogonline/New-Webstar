...
<div class="container">   
	...
	<div class="row">
		...
		<?php if($ThemeSettingheadertype=='V'):	?>
				...
				<div class="ecomerce sidebar col-md-3 hidden-xs hidden-sm main-el">
				<?php
			...
			$limit = ($ThemeSettingheadertype=='V')?3:4;
		
			$products = $this->Layout->productlist($conditions, $order, $limit);
			if(!empty($products)){
			?>
			<?php if(!empty($ThemeSetting)){ ?>
				
				<div class="<?php echo ($ThemeSettingheadertype=='V')?'col-xs-9':'col-xs-12'; ?> product-list">
			...
			<?php
				...
				?>
				<div class="<?php echo ($ThemeSettingheadertype=='V')?'col-xs-9':'col-xs-12'; ?>">
				<div class="alert alert-noicon " style="margin-top:15px;"><center>No Result Found.</center></div>
				</div>
				<?php
			}
			?>
