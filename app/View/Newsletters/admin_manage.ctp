	...
	<div class="col-md-12">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-gift"></i><?php echo (isset($id))?'Edit':'Add' ?> Newsletter
				</div>
			</div>
			
			<div class="portlet-body form">
				<!-- BEGIN FORM-->
				<?php echo $this->Form->create('Newsletter', array('action' => 'admin_manage/'.$id, 'id'=>"form_sample_3", 'class'=>"form-horizontal", "type"=>"post", 'inputDefaults' => array('required' => false, 'label' => false,'div' => false))); ?>
					<div class="form-body">
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-4">
								<?php echo $this->Form->input('subject',array('value'=>(isset($data['Newsletter']))?$data['Newsletter']['subject']:'', 
																'id'=>"name", 
																'class'=>"form-control", 
						...
						<div class="form-group">
							<label class="control-label col-md-3">Add Newsletter <span class="required">
							* </span>
							</label>
							<div class="col-md-8">
								<?php echo $this->Form->input('newsletter',
																array('value'=>(isset($data['Newsletter']))?$data['Newsletter']['newsletter']:'', 
																				//'id'=>"name",  
								...
								<div class="input-group">
									<?php  
										echo $this->Form->input('status', array(
																...
																'empty' => 'Select Status',	
																'class' => 'form-control',
																'selected'=> (isset($data['Newsletter']))?$data['Newsletter']['status']:''
															));
									?>  
								</div>
							</div>
