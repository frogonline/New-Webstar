<?php
	$revsliderTypeArr = array('1'=>'Image','2'=>'Video','3'=>'Call To Action');
?>
<?php
		...
		<div class="modal-body">
			<div class="scroller" data-always-visible="1" data-rail-visible1="1">
				<div class="row">
					...
					?>
					<div class="col-md-12">
						<h4>Background Banner Image<span class="required"> * </span></h4>
						<?php
				...
				<?php
				if($reqdata['galleryType']=="style1"){
				?>
				<div class="row">		
					<div class="col-md-12">
						<h4>Revolution Slider Type<span class="required"> * </span> </h4>
						<?php 
				...
				<div class="resliderDiv" data-mode="off" id="rev_1">
					<div class="row">		
						<div class="col-md-12">
							<h4>Banner Foreground Image<span class="required"> * </span> </h4>
							<?php 
							if(!empty($data['CmsBanner']['banner_back_image'])){
								echo $this->Html->image(IMGPATH.'cms_banner_image/background/thumb/'.$data['CmsBanner']['banner_back_image'], array('alt'=>'Slider'));
							} else {
				...
				<div class="resliderDiv" data-mode="off" id="rev_2">
					<div class="row">		
						<div class="col-md-12">
							<h4>Video Link<span class="required"> * </span> </h4>
							<?php 
							echo $this->Form->input('rev_video_link',array('value'=>(isset($slider['CmsBanner']['rev_video_link']))?$slider['CmsBanner']['rev_video_link']:'','data-required'=>1, 'class'=>"form-control",'type'=>"textarea", 'label'=>false, 'div'=>false));
							?>
						</div>
					</div>
				</div>
				<div class="resliderDiv" data-mode="off" id="rev_3">
					...
					<div class="row">		
						<div class="col-md-12">
							<h4>Call To Action Text <span class="required"> * </span> </h4>
							<?php 
