					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							* </span>
							...
							<div class="col-md-4">
								<?php echo $this->Form->input('sort_order',array('value'=>(isset($data['SocialWidget']))?$data['SocialWidget']['sort_order']:'', 'id'=>"sort_order",'class'=>"form-control", 'placeholder'=>"Enter Sort order", 'type'=>"text")); ?>
							</div>
						</div>
								...
								<div class="input-group">
									<?php  
										echo $this->Form->input('status', array(
																...
																'empty' => 'Select Status',	
																'class' => 'form-control',
																'selected'=> (isset($data['SocialWidget']))?$data['SocialWidget']['status']:''
															));
									?>  
								</div>
							</div>
