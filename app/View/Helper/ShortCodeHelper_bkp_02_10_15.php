				...
				if($portfolio_array['Portfolio']['category_type']=='Y')
				{
					...
					else
					{
						if($portfolio_array['Portfolio']['position']=='1')
						{
								...
								if($portfolio_array['Portfolio']['style']=='style2')
								{
									$divstruc = 'col-md-4';
								}
								if($portfolio_array['Portfolio']['style']=='style3')
								{
									$divstruc = 'col-md-6';
								}
								if($portfolio_array['Portfolio']['style']=='style4')
								{
								...
								$str.='</ol>
									...
									foreach($portfolio_array['PortfolioContent'] as $portcontent)
									{
									   $str.='<div class="'.$divstruc.' main-el isotope-element '.$portcontent['category'].'">
						...
						if($portfolio_array['Portfolio']['position']=='2')
						{
							...
							$str='<div class="col-md-12 main-el">
									<ol class="breadcrumb portfolio-isotope-filters">
										<li class="filter active" data-filter="*"><a>All</a></li>';
										foreach($catgories as $category)
										{
											$str.='<li class="filter" data-filter=".'.$category.'"><a>'.ucfirst($category).'</a></li>';
