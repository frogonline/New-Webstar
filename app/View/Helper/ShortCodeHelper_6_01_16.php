       ...
       foreach($all_short_code as $k=>$short_code)
	   {
			...
			else if($short_code_type[0] == 'PricePlanType')
			{
				...
				if(!empty($planpricing_array)){
					$content[$k] = ($planpricing_array['PricePlanType']['headingfrontend_flag']=='Y')?
									...
									<div class="col-md-12">
									<div class="sep-heading-container shc4 clearfix">
										<h4>'.$planpricing_array['PricePlanType']['name'].'</h4>
										<div class="sep-container">
											<div class="the-sep"></div>
										</div>
									</div>
				...
				if(isset($planpricing_array['PricePlanType']) && $planpricing_array['PricePlanType']['style']=='style2')
				{
					$content[$k] .='<div class="col-md-3 col-sm-6 col-xs-12 main-el">
										...
										{
											$content[$k] .='<div class="field">'.$cat.'</div>';
										}
										$content[$k] .='</div></div>';
							...
							foreach($Planfeature1_model as $pricingdetails)
							{
								...
								$content[$k] .= ($pricingdetails['PlanFeature']['feature_description']!='')?
									'<div class="field">'.$pricingdetails['PlanFeature']['feature_description'].'</div>':'<div class="field">---</div>';
							}
									
							$content[$k] .='<a class="button solid grey sm" href="'.$plainpricedetail['buy_link'].'"><div class="over">BUY</div></a></div></div> ';							
				...
				elseif(isset($planpricing_array['PricePlanType']) && $planpricing_array['PricePlanType']['style']=='style1')
				{
						foreach($planpricing_array['PricePlan'] as $plainpricedetail)
							{
											$content[$k] .='<div class="col-md-3 col-sm-6 col-xs-12 main-el">
																<div class="pricing table alt-bg-color"><div class="head"><h4>'.$plainpricedetail['plan_name'].'</h4></div>
															<div class="price">
															<div class="amount">'.$plainpricedetail['plan_price'].'
															<div class="unit">'.CURRENCY.'</div>
															</div>
							...
							foreach($Planfeature1_model as $pricingdetails)
							{
								$content[$k] .='<div class="field">'.$pricingdetails['PlanFeature']['feature_description'].'</div>';
							}
							$content[$k] .='<a class="button solid grey sm" href="'.$plainpricedetail['buy_link'].'"><div class="over">BUY</div></a></div>
							</div>';
							}
			...
			else if($short_code_type[0] == 'Imagebox')
			{
				...
				$content[$k] .= '<div class="main-el">
									<div class="img-box">
										<div class="thumb">
											<a class="overlay mgp-img" href="'.IMGPATH.'box_image/original/'.$imagebox_array['ImageBoxContent'][0]['image'].'">
												<i class="fa fa-search md alt-text-color"></i>
											</a>
											<img src="'.IMGPATH.'box_image/original/'.$imagebox_array['ImageBoxContent'][0]['image'].'" class="img-responsive" alt="">
										</div>
									...
									$content[$k] .='<li id="slide1" data-transition="fade" data-slotamount="1">
										...
										<div class="tp-caption caption1 lfb" data-x="center" data-voffset="90" data-y="center" data-speed="500" data-start="1200">
											...
											if(strpos($cmsbanner['button_link'],'http://')!==false)	{
												$content[$k] .='<a target="_blank" href="'.$cmsbanner['button_link'].'" class="button solid md blue">
												<div class="over">'.$cmsbanner['button_text'].'</div>
												</a>';
											} else {
												$content[$k] .='<a href="'.$cmsbanner['button_link'].'" class="button solid md blue">
												<div class="over">'.$cmsbanner['button_text'].'</div>
												</a>';
											}
			...
			else if($short_code_type[0] == 'latestproduct_list')
			{
				...
				if(!empty($latestProducts)){
					foreach($latestProducts as $latestProduct){
						$content[$k] .= $this->Html->link($this->Html->image(IMGPATH.'product_image/original/'.$latestProduct['Product']['product_image'], array('alt'=>$latestProduct['Product']['product_name'], 'class'=>'img-responsive')).'<p class="name">'.$latestProduct['Product']['product_name'].'</p><p class="price main-text-color">'.CURRENCY.number_format($this->Layout->actualprice($latestProduct['Product']['id']),2).'</p>', SITE_URL.'/'.$latestProduct['Product']['product_slug'], array('escape'=>false, 'class'=>'list-group-item'));
					}
				} else {
			...
			else if($short_code_type[0] == 'bestseller_list')
			{
				...
				if(!empty($products)){
					foreach($products as $product){
						$content[$k] .= $this->Html->link($this->Html->image(IMGPATH.'product_image/original/'.$product['Product']['product_image'], array('alt'=>$product['Product']['product_name'], 'class'=>'img-responsive')).'<p class="name">'.$product['Product']['product_name'].'</p><p class="price main-text-color">'.CURRENCY.number_format($this->Layout->actualprice($product['Product']['id']),2).'</p>', SITE_URL.'/'.$product['Product']['product_slug'], array('escape'=>false, 'class'=>'list-group-item'));
					}
				} else {
					$content[$k] .= '<div class=""></div>';
				}
				...
				if(!empty($text_array)){
							...
							foreach($text_array as $callboxWidget)
							{
								$content[$k] ='<div class="container">
												...
												<div class="col-md-12 main-el">
													<div class="call">
														<h3 class="main-text-color">'.$callboxWidget['heading'].'</h3>
														<p>'.$callboxWidget['description'].'</p>
														<a class="button solid md blue" href="'.$callboxWidget['button_link'].'"><div class="over">'.$callboxWidget['button_text'].'</div></a>
													</div>
												</div>
											</div></div>';
							}
							...
							foreach($text_array as $callboxWidget)
							{
									...
									<div class="col-sm-12 main-el">
										<div class="sep-heading-container shc4 clearfix">
											<h4>'.$text_array['CalloutBox']['heading'].'</h4>
											<div class="sep-container">
												<div class="the-sep"></div>
											</div>
										</div>
										<div class="callout">
											<div class="row">
												<p class="col-sm-9">'.$text_array['CalloutBox']['description'].'
												</p>
												<div class="col-sm-3">
													<a href="'.$text_array['CalloutBox']['button_link'].'"><div class="button solid md blue pull-right"><div class="over">'.$text_array['CalloutBox']['button_text'].'</div></div></a>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="portfolio-isotope isotope-container clearfix">';
										foreach($portfolio_array['PortfolioContent'] as $portcontent)
										{
											$str.='<div class="item-wrap isotope-element '.str_replace(" ", "-",$portcontent['category']).'">
												<div class="item">
													<a class="overlay mgp-img" href="'.IMGPATH .'portfolio_image/original/'.$portcontent['image'].'">
														<i class="fa fa-search md alt-text-color"></i>
														<div class="title light alt-text-color">'.$portcontent['title'].'</div>
													</a>
													<img src="'.IMGPATH .'portfolio_image/original/'.$portcontent['image'].'" alt="" class="img-responsive">
												</div>
											</div>';
										}
								$str.='</div>
												...
												<div class="row">
													<div class="col-sm-6 main-el">
														<div class="photo">
															...
															<img src="'.IMGPATH .'portfolio_image/original/'.$portcontent['image'].'" class="img-responsive" alt="">
														</div>
													</div>
									   ...
									   $str.='<div class="'.$divstruc.' main-el isotope-element all-'.$short_code_type[1].' '.str_replace(" ", "-",$portcontent['category']).'">
											<div class="portfolio item">
												<div class="top">
													...
													<a href="#"><img class="img-responsive" src="'.IMGPATH .'portfolio_image/original/'.$portcontent['image'].'" alt=""></a>
													...
													<div class="row">
														<div class="col-md-8 col-sm-6">
															<div class="photo">
																...
																<img class="img-responsive" src="'.IMGPATH .'portfolio_image/original/'.$portcontent['image'].'" alt="">
															</div>
														</div>
			...
			else if($short_code_type[0] == 'Form')
			{
				...
				if(!empty($form)){
					...
					if(!empty($toolArr)){
						...
						$str .= $this->Form->create('FormTable', array('url'=>array('controller'=>'FormTables','action' => 'saveform/'.$form['FormTable']['id']), 'id'=>"form_".$form['FormTable']['id'], 'class'=>"form-horizontal", "type"=>"file", 'inputDefaults' => array('required' => false, 'label' => false,'div' => false)));
						
						foreach($toolArr as $tool){
							$str .= $this->FormTool->buildTool($tool);
						}
						$str .= '<div class="row">';
						$str .= '<div class="col-md-8 col-md-offset-4 padding-left-0 padding-top-20">';
						$str .= $this->Form->button('Submit', array('type'=>'submit', 'class'=>'btn btn-primary'));
						$str .= '</div>';
						$str .= '</div>';
						$str .= $this->Form->end();
					}
