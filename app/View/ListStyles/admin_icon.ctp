<div class="modal-dialog" style="height:500px; width:1200px; z-index: 1050;">
	<div class="modal-content">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
			<h2 class="modal-title">Icon Box</h2>
		</div>
...
$(function(){
	$('.fa-item').click(function(e){
		e.preventDefault();
		var className = $(this).find('i').attr('class');
		$('#itemclsFld').val(className);
		$('#responsiveicon').modal("hide");
	});
});
</script>