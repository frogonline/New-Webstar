		...
		<?php
			...
			?>
				<tr>
					...
					<td class="numeric" align="center" style="width:300px">
						
							<?php
						    if($currentModelPer['edit']=='Y')
							{
							
							echo $this->Html->link($this->Html->image(IMGPATH1.'edit.png', array('alt'=>'loading..','Title'=>'Edit')), array('controller'=>'EmailTemplates', 'action'=>'admin_manage/'.$emailTemplate['EmailTemplate']['id']), array('escape'=>false, 'full_base'=>true, 'class'=>''));
							...
							/* if($currentModelPer['delete']=='Y')
							{
							echo $this->Html->link('<i class="fa fa-trash-o"></i> Delete', array('controller'=>'EmailTemplates', 'action'=>'admin_delete/'.$emailTemplate['EmailTemplate']['id']."/1"), array('escape'=>false, 'full_base'=>true,'confirm' => 'Do you really want to delete this record?', 'class'=>'btn default btn-xs red'));
							} */
							?>
							</div>-->
							...
							echo $this->Html->link($this->Html->image(IMGPATH1.'review.png', array('alt'=>'loading..','Title'=>'View Review')), array('controller'=>'EmailTemplates', 'action'=>'/preview/'.$emailTemplate['EmailTemplate']['id']), array('escape'=>false, 'full_base'=>true, 'class'=>'','style'=>"margin-left:20px"));
